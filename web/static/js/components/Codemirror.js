...
const CodeMirror = React.createClass({
	propTypes: {
		...
		preserveCursorPosition: React.PropTypes.bool,
	},
	getDefaultProps () {
		return {
	...
	componentDidMount () {
		...
		this.codeMirror.on('keydown', this.codemirrorKeyDown)
	...
	componentWillReceiveProps: function (nextProps) {
		if (this.props.preserveCursorPosition) var cursorPosition = this.getCursorPosition()
